...
def main():
    ...
    plt.figure()
    plt.scatter(pca_sd, pca_od, color='k')
    ...
    plt.savefig('figures/TVsets_C_PCA_outlier_map.pdf', bbox_inches='tight')

    plt.figure()
    plt.scatter(detmcd_sd, detmcd_od, color='k')
    ...
    plt.xlabel('Score Distance')
    plt.ylabel('Orthogonal Distance')
    plt.savefig('figures/TVsets_DetMCD_PCA_outlier_map.pdf', bbox_inches='tight')

    plt.figure()
    plt.scatter(fdb_sd, fdb_od, color='k')
    ...
    plt.xlabel('Score Distance')
    plt.ylabel('Orthogonal Distance')
    plt.savefig('figures/TVsets_FDB_PCA_outlier_map.pdf', bbox_inches='tight')

    plt.figure()
    plt.scatter(fir_sd, fir_od, color='k')
    ...
    plt.xlabel('Score Distance')
    plt.ylabel('Orthogonal Distance')
    plt.savefig('figures/TVsets_FIR_PCA_outlier_map.pdf', bbox_inches='tight')
